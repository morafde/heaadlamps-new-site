        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">
                Ready to transform your business? Contact Hedlamps Consulting
                Services today to learn how we can help you achieve your digital
                transformation goals and optimize your operations.
                <div className=" mt-4">
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="text-gray-400 text-sm mr-4">
              &copy; Hedlamps 2025. All rights reserved.
            </div>
          </div>
        </div>
      </div>
